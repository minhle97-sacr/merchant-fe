            ...
            <div className="min-h-screen bg-white flex flex-col">
                ...
                <header className="bg-white px-8 py-6 flex justify-between items-center">
                    <div className="flex items-center gap-4">
                        ...
                        <Logo className="" width={100} height={28} />
                    </div>
            ...
            <main className="flex-1 max-w-lg mx-auto px-8 py-12 w-full">
                                        ...
                                        {category.items.map((item: any, idx) => {
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`px-4 py-2 rounded-full border text-[11px] font-semibold transition-all ${isSelected
                ...
                <div className='flex justify-center'>
                    ...
                    <button
                        ...
                        className={`w-full max-w-sm px-8 py-3.5 rounded-full font-semibold text-base transition shadow-lg ${operationalCategory && !createMerchant.isPending
